...
defmodule SQL.LexerTest do
  ...
  describe "zero-width" do
    test "U+200B space" do
      assert_raise SyntaxError, ~r"illigal zero width character", fn ->
  ...
  describe "bidi" do
    test "U+202A ltr embedding" do
      assert_raise SyntaxError, ~r"illigal bidi character", fn ->
        SQL.Lexer.lex("SEL\u202AECT 1;")
      end
    end
  ...
  describe "combining grapheme joiner" do
    test "U+034F" do
      assert_raise SyntaxError, ~r"illigal cgj character", fn ->
